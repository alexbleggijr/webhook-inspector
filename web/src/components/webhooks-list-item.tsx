...
export function WebhooksListItem() {
  return (
    /* group permite fazer estilização nos elementos filhos com base no estado do elemento pai */
    <div className="group rounded-lg transition-colors duration-150 hover:bg-zinc-700/30">
      <div className="flex items-start gap-3 px-4 py-2.5">
        ...
        <Link to="/" className="flex flex-1 min-w-0 items-start gap-3">
          <span className="w-12 shirink-0 font-mono text-xs font-semibold text-zinc-300 text-right">
            POST
          </span>
